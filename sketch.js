...
var frame;
var keyboard, dict;
var noteNumberStack = [], noteNameStack = [], noteNameQueue = [];
...
function setup() {
  ...
  keyboard = new Keyboard(0, 0, width, 250);
